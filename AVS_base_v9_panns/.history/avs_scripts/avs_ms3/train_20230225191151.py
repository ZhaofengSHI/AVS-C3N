...
if __name__ == "__main__":
    ...
    for epoch in range(args.max_epoches):
        ...
        for n_iter, batch_data in enumerate(train_dataloader):
            imgs, audio, mask, videoname = batch_data # [bs, 5, 3, 224, 224], [bs, 5, 1, 96, 64], [bs, 5 or 1, 1, 224, 224]
            ...
            loss, loss_dict = IouSemanticAwareLoss(output, mask)
        ...
        for n_iter, batch_data in enumerate(val_dataloader):
            imgs, audio, mask, videoname = batch_data # [bs, 5, 3, 224, 224], [bs, 5, 1, 96, 64], [bs, 5, 1, 224, 224]
